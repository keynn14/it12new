...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center page-header">
    <div>
        <h1 class="h2 mb-1"><i class="bi bi-hourglass-split"></i> Pending Purchase Orders</h1>
        <p class="text-muted mb-0">Purchase orders awaiting approval</p>
    </div>
    <div>
        <a href="{{ route('purchase-orders.index') }}" class="btn btn-outline-secondary me-2"><i class="bi bi-arrow-left"></i> All POs</a>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <small class="text-muted">All purchase orders have been processed</small>
                                </div>
                            </td>
                        </tr>
                    @endforelse
