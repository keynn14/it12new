...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    <div>
        <h1 class="h2 mb-1"><i class="bi bi-truck"></i> Edit Supplier</h1>
        <p class="text-muted mb-0">Update supplier information</p>
    </div>
    <a href="{{ route('suppliers.show', $supplier) }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
</div>
    ...
    <div class="form-card-body">
        <form method="POST" action="{{ route('suppliers.update', $supplier) }}" id="supplierForm">
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" class="form-control-custom @error('name') is-invalid @enderror" value="{{ old('name', $supplier->name) }}" placeholder="Enter supplier name" required>
                        @error('name')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="address" class="form-control-custom textarea-custom @error('address') is-invalid @enderror" rows="3" placeholder="Enter supplier address">{{ old('address', $supplier->address) }}</textarea>
                        @error('address')
                            <div class="invalid-feedback-custom">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contact_person" class="form-control-custom @error('contact_person') is-invalid @enderror" value="{{ old('contact_person', $supplier->contact_person) }}" placeholder="Enter contact person name">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control-custom @error('email') is-invalid @enderror" value="{{ old('email', $supplier->email) }}" placeholder="Enter email address">
                        @error('email')
                            <div class="invalid-feedback-custom">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('suppliers.show', $supplier) }}" class="btn btn-secondary btn-cancel">
