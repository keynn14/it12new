...
@section('title', 'Create Goods Item')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    <div>
        <h1 class="h2 mb-1"><i class="bi bi-box-seam"></i> Create Goods Item</h1>
        <p class="text-muted mb-0">Add a new item to the inventory</p>
    </div>
    <a href="{{ route('inventory.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
</div>
    ...
    <div class="form-card-body">
        <form method="POST" action="{{ route('inventory.store') }}" id="itemForm">
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control-custom @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Enter item name" required>
                        @error('name')
                            <div class="invalid-feedback-custom">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </div>
                        @enderror
                        <small class="form-help-text">Enter a descriptive name for the item</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label-custom">
                        ...
                        @enderror
                        <small class="form-help-text">Select the type of item</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="unit_of_measure" class="form-control-custom @error('unit_of_measure') is-invalid @enderror" value="{{ old('unit_of_measure', 'pcs') }}" placeholder="e.g., pcs, kg, m" required>
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror
                        <small class="form-help-text">Item availability status</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="description" class="form-control-custom textarea-custom" rows="3" placeholder="Enter item description">{{ old('description') }}</textarea>
                        <small class="form-help-text">Additional details about the item</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('inventory.index') }}" class="btn btn-secondary btn-cancel">
